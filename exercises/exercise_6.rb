...
@store1.employees.create(first_name: "Ricky", last_name: "Chan", hourly_rate: 70)
@store1.employees.create(first_name: "Vivian", last_name: "Chan", hourly_rate: 100)

@store2.employees.create(first_name: "Carols", last_name: "Parah", hourly_rate: 80)
@store2.employees.create(first_name: "Lightening", last_name: "Verose", hourly_rate: 90)
@store2.employees.create(first_name: "Squall", last_name: "Leonhart", hourly_rate: 50)
